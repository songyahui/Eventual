...
For \lstinline{putMVar}, the future asserts that \lstinline{putMVar(v)}
must not recur until \lstinline{takeMVar(v)} is called again, preventing
double-put.
...
Here \lstinline{pure ()} has $\post = \varepsilon$.
